        ...
        <div className="min-h-[85vh] flex items-center justify-center px-4 bg-bg-dark text-text-main">
            <div className="w-full max-w-md bg-card-dark p-8 rounded-2xl shadow-2xl border border-border-main relative overflow-hidden animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {error && (
                        <div className="p-3 bg-error/10 text-error text-xs rounded-xl border border-error/20 flex items-start gap-2.5 font-semibold">
                ...
                <div className="mt-6 text-center border-t border-border-main pt-5">
                    <p className="text-text-muted text-sm font-semibold">
                        Already have an account?{' '}
                        <Link to="/login" className="text-secondary hover:text-secondary-hover font-extrabold transition-colors">
                            Sign In
                        </Link>
                    </p>
                </div>
